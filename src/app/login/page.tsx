  ...
  return (
    <div className="grid min-h-svh grid-cols-1 md:grid-cols-[1.2fr_1fr] lg:grid-cols-[1.5fr_1fr]">
      ...
      <div className="relative hidden flex-col justify-between bg-primary p-10 text-white md:flex">
        ...
        <Link
          href="/"
          className="relative z-10 flex w-fit items-center gap-2 font-semibold text-white hover:text-on-primary-container"
        >
          <ShieldCheck className="size-6 text-accent-bright" aria-hidden />
