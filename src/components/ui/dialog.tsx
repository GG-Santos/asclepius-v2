  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-lg border border-outline-variant/60 bg-card p-5 shadow-[var(--shadow-clinical-md)] focus:outline-none",
          className,
        )}
        {...props}
      >
