...
export const AnimatedThemeToggler = ({
  ...
  const activeTheme = isControlled ? theme : resolvedTheme;
  ...
  if (!mounted || !activeTheme) {
    return <div className={cn("size-8 rounded", className)} aria-hidden />;
  }
  ...
  return (
    <button
      ...
      className={cn(
        "rounded p-1.5 text-on-surface-variant transition-colors hover:bg-surface-container hover:text-accent [&_svg]:size-4",
        className,
      )}
      {...props}
    >
