...
function Marker({
  ...
  // Lift the avatar above the surface while keeping the DOM hit target centered
  // on the projected marker coordinate.
  ...
  const markerDiameter = `${Math.max(26, markerSize * 340)}px`;
  const outlineColor = marker.outlineColor ?? "#ffffff";
      ...
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          <button
            type="button"
            className={cn(
              "cursor-pointer overflow-hidden rounded-full bg-neutral-900 p-0 shadow-lg transition-transform duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/70",
            ...
            onClick={handleClick}
          >
            {/* biome-ignore lint/performance/noImgElement: tiny remote marker avatars are rendered inside Three Html */}
            <img
              src={marker.src}
